        ...
        <form onSubmit={onSubmit} className="space-y-6">
            <div className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        <InputLabel htmlFor="manager_id" value={t('Directeur de projet')} />
                        <select
                            id="manager_id"
                            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300"
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                <h3 className="mb-4 font-semibold text-slate-800 dark:text-slate-100">{t('Budget & délais')}</h3>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {field('budget_amount', t('Budget *'), { type: 'number', min: 0, step: '0.01' })}
                    <div>
                    ...
                    {field('progress', t('Avancement (%)'), { type: 'number', min: 0, max: 100 })}
