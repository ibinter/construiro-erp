    ...
    return (
        <form onSubmit={onSubmit} className="space-y-6">
            <div className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                <h3 className="mb-4 font-semibold text-slate-800 dark:text-slate-100">Prix unitaire</h3>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    {field('code', 'Code *', { placeholder: 'BPU-001' })}
                    {field('designation', 'Désignation *', { placeholder: 'Béton dosé 350 kg/m3' })}
                    ...
                    {field('unit_price', 'Prix unitaire *', { type: 'number', min: 0, step: '0.01', placeholder: '95000' })}
                ...
                <div className="mt-4">
                    <label className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-sm text-slate-600 dark:text-slate-300">Prix actif</span>
                    </label>
