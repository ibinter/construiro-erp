                ...
                <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-800">
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                        {incidents.data.map((incident) => (
                            <tr key={incident.id} className="text-sm hover:bg-slate-50 dark:hover:bg-slate-800/50">
                                <td className="px-4 py-3">
                                    <Link href={`/hse/${incident.id}`} className="font-medium text-slate-800 hover:text-orange-600 dark:text-slate-100">
                                        {incident.title}
                                    </Link>
                                    <div className="text-xs text-slate-400">
                                        {incident.code}{incident.project ? ` · ${incident.project.name}` : ''}
                                    </div>
                                </td>
                                ...
                                <td className="px-4 py-3"><Badge map={INCIDENT_STATUS} value={incident.status} /></td>
                                <td className="px-4 py-3 text-right">
                                    <Link href={`/hse/${incident.id}`} className="text-slate-400 hover:text-orange-600">
