        ...
        <form onSubmit={onSubmit} className="space-y-6">
            <div className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    {field('title', 'Intitulé *', { placeholder: 'Chute de plain-pied' })}

                    <div>
                        <InputLabel htmlFor="type" value="Type *" />
                        <select id="type" className={selectClass} value={data.type} onChange={(e) => setData('type', e.target.value)}>
                            {(types.length ? types : Object.keys(INCIDENT_TYPE)).map((t) => (
                    ...
                    <div>
                        <InputLabel htmlFor="severity" value="Gravité *" />
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                <h3 className="mb-4 font-semibold text-slate-800 dark:text-slate-100">Localisation & rattachement</h3>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    {field('location', 'Lieu', { placeholder: 'Zone de travaux, étage…' })}
                    {field('reported_by', 'Déclaré par', { placeholder: 'Nom du déclarant' })}
                ...
                <div className="mt-4">
                    <InputLabel htmlFor="corrective_action" value="Action corrective" />
                    <textarea
