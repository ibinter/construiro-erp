        ...
        <AppLayout header="Maintenance">
            ...
            <div className="mb-6 rounded-xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
                <div className="flex items-center gap-2 text-slate-400">
                    ...
                    <span className="text-xs uppercase tracking-wider">Coût total des entretiens</span>
                </div>
            ...
            <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                >
                    ...
                    {typeOptions.map((t) => (
                        <option key={t} value={t}>{MAINTENANCE_TYPE[t] ?? t}</option>
                    ))}
                </select>
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)}>
                <form onSubmit={submit} className="p-6">
                    <h3 className="mb-4 text-lg font-semibold text-slate-800 dark:text-slate-100">Nouvel entretien</h3>
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div className="sm:col-span-2">
                            <InputLabel htmlFor="mt_equipment" value="Équipement *" />
