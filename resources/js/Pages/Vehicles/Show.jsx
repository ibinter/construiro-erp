...
// Fiche véhicule (lecture seule). L'édition passe par le module Parc matériel.
...
export default function Show({ equipment }) {
    ...
    return (
        <AppLayout header="Fiche véhicule">
            ...
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                    <div className="flex items-center gap-2">
                        <Link href="/vehicles" className="text-slate-400 hover:text-orange-600">
                ...
                >
                    <Icon name="external-link" className="h-4 w-4" /> Ouvrir dans le parc matériel
                </Link>
            </div>
