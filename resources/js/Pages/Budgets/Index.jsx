                ...
                >
                    <div className="relative">
                        ...
                        <input
                            ...
                            placeholder={t('Rechercher un budget…')}
                    ...
                    >
                        ...
                        {statuses.map((s) => (
                            <option key={s} value={s}>{t(BUDGET_STATUS[s]?.label ?? s)}</option>
                        ))}
                    </select>
                </form>
                ...
                <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-800">
                    <thead className="bg-slate-50 dark:bg-slate-800/50">
                        <tr className="text-left text-xs font-semibold uppercase tracking-wider text-slate-500">
                            ...
                            <th className="px-4 py-3">{t('Exercice')}</th>
                            <th className="px-4 py-3">{t('Statut')}</th>
                            <th className="px-4 py-3 text-right">{t('Montant total')}</th>
