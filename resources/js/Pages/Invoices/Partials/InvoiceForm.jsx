...
/**
 * Formulaire partagé création / édition d'une facture.
        ...
        <form onSubmit={onSubmit} className="space-y-6">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    {field('code', 'Code facture *', { placeholder: 'FAC-2026-001' })}
                    ...
                    {field('issue_date', 'Date d\'émission', { type: 'date' })}
                    {field('due_date', 'Date d\'échéance', { type: 'date' })}
                </div>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                <div className="mb-4 flex items-center justify-between">
                    <h3 className="font-semibold text-slate-800 dark:text-slate-100">Lignes de la facture</h3>
                    <button
                        type="button"
                        onClick={addLine}
