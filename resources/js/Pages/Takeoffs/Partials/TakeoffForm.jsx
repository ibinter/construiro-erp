        ...
        <form onSubmit={onSubmit} className="space-y-6">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    {field('code', 'Code métré *', { placeholder: 'MET-2026-001' })}
                    {field('title', 'Intitulé *', { placeholder: 'Métré gros œuvre R+1' })}
                    ...
                    <div>
                        ...
                        >
                            {(statuses.length ? statuses : Object.keys(TAKEOFF_STATUS)).map((s) => (
                                <option key={s} value={s}>{TAKEOFF_STATUS[s] ?? s}</option>
                            ))}
                        </select>
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                <div className="mb-2 flex items-center justify-between">
                    <h3 className="font-semibold text-slate-800 dark:text-slate-100">Lignes de métré</h3>
                    <button
                        type="button"
                        onClick={addLine}
                ...
                <p className="mb-4 text-xs text-slate-400">
                    Renseignez les dimensions (L × l × h) pour un calcul automatique, sinon saisissez directement la quantité.
                </p>
                    ...
                    <table className="min-w-full text-sm">
                        <thead>
                            <tr className="text-left text-xs font-semibold uppercase tracking-wider text-slate-500">
                                ...
                                <th className="pb-2 px-2 w-20">Unité</th>
                                <th className="pb-2 px-2 w-20">Nb</th>
                                <th className="pb-2 px-2 w-24">Long.</th>
                                <th className="pb-2 px-2 w-24">Larg.</th>
                                <th className="pb-2 px-2 w-24">Haut.</th>
                                <th className="pb-2 px-2 w-28 text-right">Quantité</th>
