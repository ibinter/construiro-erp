        ...
        <AppLayout header="Stocks">
                            ...
                            return (
                                <tr key={s.id} className="text-sm hover:bg-slate-50 dark:hover:bg-slate-800/50">
                                    ...
                                    <td className="px-4 py-3 text-slate-600 dark:text-slate-300">
                                        {MATERIAL_CATEGORY[s.category] ?? s.category}
                                    </td>
                        ...
                        {stocks.length === 0 && (
                            <tr>
                                <td colSpan={4} className="px-4 py-12 text-center text-slate-400">
                                    ...
                                    Aucun matériau. Créez d'abord des matériaux.
                                </td>
                            </tr>
                        )}
                    </tbody>
            ...
            <div className="mt-6 rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
                <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4 dark:border-slate-800">
                    ...
                    <Link href="/stocks/movements" className="text-sm text-orange-600 hover:underline">Tout voir</Link>
                </div>
                <ul className="divide-y divide-slate-100 dark:divide-slate-800">
                    ...
                    {movements.length === 0 && (
                        <li className="px-5 py-8 text-center text-sm text-slate-400">Aucun mouvement enregistré.</li>
                    )}
                </ul>
            </div>
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)}>
                <form onSubmit={submit} className="p-6">
                    <h3 className="mb-4 text-lg font-semibold text-slate-800 dark:text-slate-100">Nouveau mouvement de stock</h3>
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            <InputLabel htmlFor="mv_type" value="Type *" />
                            <select
                                id="mv_type"
                        ...
                        <div>
                            <InputLabel htmlFor="mv_warehouse" value="Magasin *" />
                            <select
                                id="mv_warehouse"
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300"
                        ...
                        <div className="sm:col-span-2">
                            <InputLabel htmlFor="mv_material" value="Matériau *" />
                            <select
                                id="mv_material"
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300"
                        ...
                        <div>
                            <InputLabel htmlFor="mv_quantity" value="Quantité *" />
                        ...
                        <div>
                            <InputLabel htmlFor="mv_price" value="Prix unitaire *" />
                        ...
                        <div>
                            <InputLabel htmlFor="mv_reference" value="Référence" />
                        ...
                        <div>
                            <InputLabel htmlFor="mv_date" value="Date *" />
