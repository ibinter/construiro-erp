        ...
        <>
            ...
            {open && (
                <div className="fixed bottom-24 right-5 z-[9999]"
                    style={{ animation: 'saraSlideUp 0.25s ease both' }}>
            ...
            <div className="fixed bottom-5 right-5 z-[9999] flex flex-col items-end gap-3">
                ...
                <a href="https://wa.me/2252722276014?text=Bonjour%20IBIG%20Soft%2C%20je%20souhaite%20obtenir%20des%20informations%20sur%20CONSTRUIRO%20ERP."
                    ...
                    className="group relative w-12 h-12 rounded-full flex items-center justify-center shadow-lg transition hover:scale-110"
                    ...
                    {/* Tooltip */}
                    <span className="absolute right-14 whitespace-nowrap bg-gray-900 text-white text-xs px-2.5 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition pointer-events-none"
                ...
                <div className="relative">
                    ...
                    {/* Tooltip + badge */}
                    {!open && (
                        <div className="absolute bottom-full right-0 mb-2 whitespace-nowrap pointer-events-none"
                            style={{ animation: 'saraSlideUp 0.3s ease both' }}>
