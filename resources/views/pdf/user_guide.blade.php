...
.cover { min-height: 100vh; background: linear-gradient(135deg, #ea580c, #f59e0b); color: white; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; padding: 60px; page-break-after: always; }
...
h1 { font-size: 22px; font-weight: 900; color: #ea580c; border-bottom: 3px solid #ea580c; padding-bottom: 8px; margin-bottom: 20px; }
...
.tip { background: #fff7ed; border-left: 4px solid #ea580c; padding: 10px 14px; margin: 12px 0; border-radius: 0 8px 8px 0; }
.tip-title { font-weight: 700; color: #ea580c; margin-bottom: 4px; font-size: 11px; }
...
.toc li a { color: #ea580c; text-decoration: none; }
...
<div class="cover">
    ...
    <div class="cover-badge">ERP BTP • IBIG Soft</div>
    ...
    <div class="cover-meta">
        {{ $locale === 'fr' ? 'Version' : 'Version' }} {{ $version }} — {{ now()->format('Y') }}<br>
        {{ $locale === 'fr' ? 'IBIG SARL — Intermark Business International Group' : 'IBIG SARL — Intermark Business International Group' }}
    </div>
</div>
...
<div class="page">
    ...
    <div class="tip">
        ...
        Votre administrateur peut personnaliser les rôles et permissions depuis Administration → Utilisateurs.
    </div>
    @else
    ...
    <div class="tip">
        ...
        Your administrator can customize roles and permissions from Administration → Users.
    </div>
    @endif
</div>
...
<div class="page">
    ...
    <ul>
        ...
        <li><strong>Fil d'Ariane</strong> : navigation entre les niveaux (ex: Projets → Projet A → Chantiers)</li>
    </ul>
    @else
    <h2>Logging in</h2>
    <ol>
    ...
    <ul>
        ...
        <li><strong>Breadcrumb</strong>: navigation between levels (e.g.: Projects → Project A → Sites)</li>
    </ul>
    @endif
</div>
